...
label R_acceptance_rate = 'Residual: acceptance_rate' ;
...
*****  RESIDUALS R_ *************;
IF MISSING( acceptance_rate ) THEN R_acceptance_rate  = .;
ELSE R_acceptance_rate  = acceptance_rate  - P_acceptance_rate ;
